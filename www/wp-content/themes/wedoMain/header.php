...
<head>
    ...
    <link rel="stylesheet" href="<?=App::$app->pathAsset?>/css/main.css">
    <link rel="shortcut icon" href="<?=App::$app->pathAsset?>/img/logo_fav.ico" type="image/x-icon">

    <script src="https://code.jquery.com/jquery-3.2.1.min.js" integrity="sha256-hwg4gsxgFZhOsEEamdOYGBf13FyQuiTwlAQgxVSNgt4=" crossorigin="anonymous"></script>
    <script src="<?=App::$app->pathAsset?>/js/jquery.selectric.js"></script>
    <script src="<?=App::$app->pathAsset?>/js/bootstrap-formhelpers.min.js"></script>
